...
// 用来绘图的颜色
#define COLOR_SNAKE			RGB(93, 105, 205)
#define COLOR_FOOD			RGB(53, 155, 51)
#define COLOR_BOUNDARY		RGB(39, 134, 130)
#define COLOR_TEXT			RGB(73,116,230)

// 游戏的参数的设置 
#define INIT_TIMER_ELAPSE	300	// 初始的时钟周期，确定游戏初始速度
#define	ONE_LEVELS_SCORES	5	// 每升级一次需要的计分
#define INIT_SNAKE_LEN		2	// 蛇的长度
